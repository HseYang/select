...
Selectize.prototype = {
	...
	initStyle: function() { // 自定义style
		var styleText =
			'.select_view{width:100%;height:auto;overflow:hidden;border:1px solid black}.select_search_ul{width:100%;height:auto;list-style:none;padding:0 5px;box-sizing:border-box;min-height:30px}.select_search_ul li{float:left;border-color:#367fa9;padding:0 5px;margin:5px 5px;background-color:#e4e4e4;border:1px solid #aaa;border-radius:4px;color:#333;font-size:14px;box-sizing:border-box}.select_search_ul li span{font-size:10px;height:100%;padding:0 5px;color:#999;cursor:pointer;display:inline-block;font-weight:bold}.select_search_ul li span:hover{color:black}.select_search_li_input{background-color:transparent!important;width:10px;border-color:transparent!important;width:50px}.select_search_li_input::after{clear:right}.select_search_input{width:25px;outline:0;border:0;background-color:transparent}.select_value_view{display:none;width:100%;position:relative}.select_value_ul{list-style:none;width:100%;height:200px;background-color:white;border:1px solid #aaa;box-sizing:border-box;overflow-y:auto;position:absolute;top:0;left:0;z-index:99}.select_value_ul li{padding:6px 12px;cursor:pointer;font-size:14px}.select_value_ul li:hover{background-color:#5897fb;border-color:#367fa9;color:white}.select_value_selected{background-color:#ddd;color:#444}.select_search_hide{display:none}'
